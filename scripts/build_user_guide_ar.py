...
SECTIONS = [
    ...
    # ------------------------------------------------------------ malware
    {"title": "10) تحليل البرمجيات الخبيثة والإخفاء التنفيذي (Malware & Executable Stego)", "steps": [
        ...
        "<b>الإخفاء داخل الملفات التنفيذية (موضوع البرامج الضارة/الفيروسات)</b>: اختر حامل PE تدريبي + ملفاً سرياً + مفتاحاً ← اختر التقنية: <b>overlay</b> (إلحاق بعد آخر قسم) أو <b>slack</b> (داخل الحشو — حجم الملف لا يتغير) ← زر <b>Hide in specimen</b>.",
        "زر <b>Scan hidden data</b>: يكشف الغطس statically (overlay + slack) ويحدد القسم والسعة.",
        "زر <b>Extract from specimen</b> بنفس المفتاح: يسترجع الملف السري بايت-ببايت مع SHA-256.",
        "التحليل الساكن <b>يضع مؤشر Executable stego</b> تلقائياً عند العثور على غطس — حلقة الإخفاء/الكشف/الاستخراج مكتملة، ولا يُنفَّذ أي ملف أبداً.",
    ], "notes": ["التحليل الديناميكي/الـ sandbox محجوب دائماً بتصميم أمني — هذا مقصود وليس نقصاً.",
                 "الإخفاء التنفيذي يعمل على نسخ وحوامل تدريبية صناعية بلا كود — لأغراض التعليم والكشف."],
     "shots": [("s27_malware_malware.png", "تحليل ساكن لأرشيف: درجة ومؤشرات وثقة، دون تنفيذ."),
               ("s28_malware_exec_stego_hide.png", "إخفاء حمولة داخل حامل PE بتقنية slack — الحجم لم يتغير (2048←2048) والقسم .text."),
               ("s29_malware_exec_stego_scan.png", "كشف الغطس statically: blob داخل حشو القسم مع بيان السعة."),
               ("s30_malware_exec_stego_extract.png", "استخراج الحمولة بايت-ببايت مع SHA-256 للتحقق."),
               ("s31_malware_exec_stego_flag.png", "التحليل الساكن يضع مؤشر Executable stego على الحامل المخفي.")]},
    ...
    {"title": "11) التقارير ومركز الاستخراج (Reports / Extraction)", "steps": [
     ...
     "shots": [("s32_reports_reports.png", "توليد PDF+HTML+JSON لقضية حقيقية."),
               ("s33_extraction_extraction.png", "مركز الاستخراج يجمع المخرجات.")]},
